READ ME for IBV illumina processing

Overview
- A single shell script (IRMA_miseq.sh or IRMA_nextseq.sh) calls several python scripts to do the following:
	...
	- The only difference between IRMA_miseq.sh and IRMA_nextseq.sh is the python script that changes file names because miseq and nextseq have different naming conventions 
Requirements
...
- update IRMA_*seq.sh with relevant names
...
Usage: "sbatch IRMA_miseq.sh" or "IRMA_nextseq.sh"
