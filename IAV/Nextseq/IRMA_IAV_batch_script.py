...
scripts_dir = "/nfs/turbo/umms-alauring/shared_projects/IAV_illumina/"+ args.prefix + "/scripts"
working_dir = "/nfs/turbo/umms-alauring/shared_projects/IAV_illumina/"+ args.prefix
trim_dir = "/nfs/turbo/umms-alauring/shared_projects/IAV_illumina/"+ args.prefix + "/data/cutadapt"
fastq_dir = "/nfs/turbo/umms-alauring/shared_projects/IAV_illumina/"+ args.prefix + "/data/fastq_renamed"
...
IRMA FLU {trim_dir}/{indiv}.1.primertrimmed.fastq {trim_dir}/{indiv}.2.primertrimmed.fastq {indiv}
