...
module load R/4.2.0
cd 20221220_IAV_Illumina_Run_34_v1
python ../cp_fastq_files.py --sequencing_run 20230119_IAV_Illumina_Run_33_34 --map 20221220_IAV_Illumina_Run_34.csv --mode run
python ../change_names_miseq.py -s data/fastq -f data/fastq_renamed -run
python ../Run_IRMA_Pipeline_IAV_illumina.py --prefix 20221220_IAV_Illumina_Run_34 --mode run --min-length 11819
